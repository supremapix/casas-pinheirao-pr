      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
        <div className="max-w-3xl">
          <div className="inline-flex items-center space-x-2 sm:space-x-3 bg-pinheirao-green/20 backdrop-blur-md border border-pinheirao-green/30 px-3 sm:px-4 py-2 mb-6 sm:mb-8 rounded-sm animate-fade-in-down">
            ...
            <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-wider sm:tracking-[0.3em] text-white">
              Qualidade e tradição desde 2004
            </span>
          </div>
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 sm:mb-12 leading-relaxed font-medium max-w-xl animate-fade-in-up drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
            Referência em casas de madeira nobre e alvenaria em Curitiba e
            Região. Projetos personalizados que cabem no seu bolso e realizam
            seu sonho.
          </p>
          ...
          <div className="mt-12 sm:mt-16 md:mt-20 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {["Madeira de Lei", "Entrega Ágil", "Projetos Autorais", "Custo-Benefício"].map(
              (feature, i) => (
                <div key={i} className="flex items-center space-x-2">
                  <CheckCircle
                    size={12}
                    className="text-pinheirao-green shrink-0 sm:w-3.5 sm:h-3.5"
                  />
                  <span className="text-[10px] sm:text-[11px] font-black uppercase tracking-wide sm:tracking-widest text-white">
                    {feature}
                  </span>
                </div>
              )
