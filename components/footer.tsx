      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-20">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-pinheirao-gray mb-8 leading-relaxed font-medium text-sm">
              Realizando o sonho da casa própria com qualidade, tradição e o
              melhor custo-benefício de Curitiba e região há mais de 20 anos.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                className="bg-white/5 p-4 rounded-full hover:bg-pinheirao-green transition-colors text-white"
              >
                <Instagram size={20} />
              </a>
              <a
          ...
          <div className="lg:col-span-1">
            <h3 className="text-xs font-black uppercase tracking-[0.3em] text-pinheirao-green mb-10 underline decoration-2 underline-offset-8 decoration-pinheirao-green/30">
              Links Rápidos
            </h3>
            <ul className="space-y-4 text-xs font-bold text-pinheirao-concrete/70 uppercase tracking-widest">
              <li>
                <Link
                  href="/"
                  className="hover:text-pinheirao-green transition-colors flex items-center group"
                >
                  <ChevronRight
                    size={14}
                    className="mr-2 opacity-0 group-hover:opacity-100 transition-all -ml-6 group-hover:ml-0"
                  />{" "}
                  Home
                </Link>
              </li>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-6 text-xs text-pinheirao-concrete/80 uppercase tracking-widest font-bold">
              <li className="flex items-start">
                <MapPin
                  size={18}
                  className="mr-4 text-pinheirao-green shrink-0"
                />
              ...
              <li className="flex items-center">
                ...
                <span className="break-all lowercase tracking-normal font-medium">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-8 p-6 bg-white/5 border border-white/10 rounded-sm">
              <p className="text-[10px] font-black uppercase tracking-widest text-pinheirao-green mb-2">
                Presença em Todo PR
              </p>
              <p className="text-[11px] text-pinheirao-concrete/60 font-medium">
                Pinhais, Curitiba, Região Metropolitana e Litoral do Paraná.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-[10px] font-black uppercase tracking-[0.2em] text-pinheirao-gray border-t border-white/5 pt-12 gap-4">
          ...
          >
            ...
            <Heart
              size={18}
              className="text-red-500 animate-heartbeat inline-block fill-red-500"
            />
            <span className="text-white/70 normal-case tracking-normal font-medium">
              por
            </span>
            <span className="text-white group-hover:text-pinheirao-green transition-colors font-bold">
